<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Update Application #') }}{{ $application->id }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('applicant.applications.update', $application) }}" method="POST" id="appForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div id="tab-1" class="block">
                            ...
                            <input type="hidden" name="charity_type_id" value="{{ $application->charity_type_id }}">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="applicant_address" rows="3" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 shadow-sm" required>{{ old('applicant_address', $application->applicant_address) }}</textarea>
                            </div>

                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                                <div>
                                    <label class="block font-medium text-sm text-gray-700 dark:text-gray-300">Mobile Phone No. *</label>
                                    <input type="text" name="applicant_phone" value="{{ old('applicant_phone', $application->applicant_phone) }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 shadow-sm" required>
                                </div>
                                <div>
                        ...
                        <div id="tab-2" class="hidden">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl mb-6 border dark:border-gray-700">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="father_name" value="{{ old('father_name', $application->father_name) }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 shadow-sm" required>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" id="father_income_input" name="father_income" value="{{ old('father_income', $application->father_income) }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 shadow-sm" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl mb-6 border dark:border-gray-700">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="mother_name" value="{{ old('mother_name', $application->mother_name) }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 shadow-sm" required>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" id="mother_income_input" name="mother_income" value="{{ old('mother_income', $application->mother_income) }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 shadow-sm" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-xl mb-6 border border-orange-200 dark:border-orange-800 flex justify-between items-center shadow-inner">
                                ...
                                <span id="display_total_income" class="text-2xl font-black text-orange-600 dark:text-orange-400">RM {{ number_format($application->total_income, 2) }}</span>
                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <select name="bank_name" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 shadow-sm" required>
                                            ...
                                            <option value="CIMB Bank" {{ old('bank_name', $application->bank_name) == 'CIMB Bank' ? 'selected' : '' }}>CIMB Bank</option>
                                            <option value="Public Bank" {{ old('bank_name', $application->bank_name) == 'Public Bank' ? 'selected' : '' }}>Public Bank</option>
                                            <option value="RHB Bank" {{ old('bank_name', $application->bank_name) == 'RHB Bank' ? 'selected' : '' }}>RHB Bank</option>
                                            <option value="Hong Leong Bank" {{ old('bank_name', $application->bank_name) == 'Hong Leong Bank' ? 'selected' : '' }}>Hong Leong Bank</option>
                                            <option value="AmBank" {{ old('bank_name', $application->bank_name) == 'AmBank' ? 'selected' : '' }}>AmBank</option>
                                            <option value="Bank Islam" {{ old('bank_name', $application->bank_name) == 'Bank Islam' ? 'selected' : '' }}>Bank Islam</option>
                                            <option value="Bank Rakyat" {{ old('bank_name', $application->bank_name) == 'Bank Rakyat' ? 'selected' : '' }}>Bank Rakyat</option>
                                            <option value="BSN" {{ old('bank_name', $application->bank_name) == 'BSN' ? 'selected' : '' }}>BSN (Bank Simpanan Nasional)</option>
                                            <option value="Bank Muamalat" {{ old('bank_name', $application->bank_name) == 'Bank Muamalat' ? 'selected' : '' }}>Bank Muamalat</option>
                                            <option value="Agrobank" {{ old('bank_name', $application->bank_name) == 'Agrobank' ? 'selected' : '' }}>Agrobank</option>
                                        </select>
                                    </div>
                                    <div>
                        ...
                        <div id="tab-4" class="hidden">
                            ...
                            <div class="mt-6 flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <button type="submit" class="px-6 py-2 bg-indigo-600 text-white font-bold rounded hover:bg-indigo-700 transition shadow-md">Save Changes</button>
                                </div>
                            </div>
                        </div>
